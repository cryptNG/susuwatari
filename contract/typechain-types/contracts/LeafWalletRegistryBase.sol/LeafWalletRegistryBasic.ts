...
export interface LeafWalletRegistryBasicInterface extends utils.Interface {
  functions: {
...
export interface LeafWalletRegistryBasic extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LeafWalletRegistryBasicInterface;
