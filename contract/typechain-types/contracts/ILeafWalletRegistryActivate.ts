...
export interface ILeafWalletRegistryActivateInterface extends utils.Interface {
  functions: {
...
export interface ILeafWalletRegistryActivate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ILeafWalletRegistryActivateInterface;
