...
export interface LeafWalletRegistryCoreInterface extends utils.Interface {
  functions: {
...
export interface LeafWalletRegistryCore extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LeafWalletRegistryCoreInterface;
